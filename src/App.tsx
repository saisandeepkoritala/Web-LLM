...
// Matches the backend Candidate structure
...
export default function App() {
  ...
  const handleSearch = async (e: React.FormEvent) => {
    ...
    setQuery(""); // Clear input early for UX
    setIsLoading(true);

    try {
      // Adjust this URL/port to point exactly to your backend route
      ...
      // Append the new exchange to our history state
      setHistory((prev) => [
        ...prev,
        {
  ...
  return (
    ...
    <div className="space-y-4">
      {history.map((exchange, index) => {
        ...
        // This safely extracts URLs whether your backend returned a flat string array, 
        // or an array of objects like pageSummaries [{url, summary}].
          ...
          <Card key={index} className="overflow-hidden border-neutral-200 dark:border-neutral-800">
            ...
            <CardContent className="pt-5 pb-6 space-y-4">
              ...
              {/* 💡 BULLETPROOF RENDERING: 
                  We removed 'exchange.mode === "web"' entirely. 
                  If there are sources in the array, we force them to render no matter what! */}
